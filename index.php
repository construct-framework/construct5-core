...
<body class="<?php echo $columnLayout . ' sticky-footer ' . $currentComponent; if($articleId) echo ' article-' . $articleId; if($itemId) echo ' item-' . $itemId; if($catId) echo ' category-' . $catId ?>">
