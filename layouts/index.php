...
<body id="page-top" class="<?php echo $columnLayout . ' ' . $currentComponent; if ($itemId) echo ' ' . $currentAlias; if ($articleId) echo ' article-' . $articleId; if ($itemId) echo ' item-' . $itemId; if ($catId) echo ' category-' . $catId ?>">
...
<header id="header" class="clear clearfix">
	<div class="gutter clearfix">
		...
		<ul id="style-switch">
			<li>
				<a href="#" onclick="setActiveStyleSheet('wireframe'); return false;" title="Wireframe">Wireframe</a>
			</li>
			<li>
				<a href="#" onclick="setActiveStyleSheet('diagnostic'); return false;" title="Diagnostic">Diagnostic Mode</a>
			</li>
			<li>
				<a href="#" onclick="setActiveStyleSheet('normal'); return false;" title="Normal">Normal Mode</a>
			</li>
		</ul>
